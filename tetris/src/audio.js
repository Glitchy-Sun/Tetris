+function() {
  ...
  var audioCtx, keyAudioBuffers = [], spaceAudioBuffer, ambiencesBuffer,
  ...
  // try {
    ...
    loadAudioBuffer( 'ambiences.ogg', function( buffer ) {
      ambienceAudioSource = playAudio( ambiencesBuffer = buffer, true )
    })
    ...
    document.getElementById("mute-sound").addEventListener( "click", function( e ) {
      ...
      if ( muteSound )
        ...
        ambienceAudioSource = playAudio( ambiencesBuffer, true )
